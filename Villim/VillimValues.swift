...
class VillimValues {
    ...
    public static let backgroundColor          = UIColor(red:1.00, green:1.00, blue:0.98, alpha:1.0)
    ...
    public static let searchFieldBorderColor   = UIColor(red:  5.0/255.0,  green:   6.0/255.0, blue:  11.0/255.0, alpha:1.0)
