...
class CancellationPolicyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        policyTitle.text = NSLocalizedString("cancellation_policy", comment: "")
        ...
        policyContent.text = cancellationPolicy
    ...
    func makeConstraints() {
        ...
        policyTitle?.snp.makeConstraints { (make) -> Void in
            ...
            make.top.equalToSuperview().offset(topOffset + sideMargin * 0.3)
