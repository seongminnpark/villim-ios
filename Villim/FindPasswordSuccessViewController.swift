...
protocol FindPasswordSuccessDelegate {
    func onDismiss()
}

class FindPasswordSuccessViewController: UIViewController {

    var dismissDelegate : FindPasswordSuccessDelegate!
    ...
    override func viewDidLoad() {
        ...
        titleMain.text = NSLocalizedString("find_password_success_title", comment: "")
        ...
        instruction.text = NSLocalizedString("find_password_success_instruction", comment: "")
    ...
    func makeConstraints() {
        ...
        /* ImageView */
        planeImage?.snp.makeConstraints { (make) -> Void in
        ...
        titleMain?.snp.makeConstraints { (make) -> Void in
            ...
            make.top.equalTo(planeImage.snp.bottom).offset(VillimValues.sideMargin * 2)
        }
    ...
    func populateViews() {
        planeImage.image = #imageLiteral(resourceName: "img_paper_plane")
    }
